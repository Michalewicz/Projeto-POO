...
```
## Como usar o projeto
Segue a lista de todas as funcionalidades do projeto, e de como acessa-las.
<hr>
...
- Para visualizar a página principal, o usuário deve primeiro criar uma conta (ou entrar em uma já existênte) usando os botões do menu, ou os links localizados logo abaixo da descrição do site.
...
- A página de registro possui quatro campos: email, nome, senha e confirmar senha, além de um link direcionando para a página de login no final. Caso o usuário não tenha uma conta, ele deve preencher todos os campos com as devidas informações.
- A página de login possui dois campos: email e senha, além de um link direcionando para a página de registro no final. Caso o usuário tenha uma conta, ele deve preencher todos os campos as informações de sua conta para entrar no site.
- A página de perfil possui as informações do email e nome da conta do usuário, além de campos para o usuário mudar seu nome e senha, e um botão para desconectar da conta.
<hr>

### Página de Estatísticas
- Esta página exibe as seguintes informações sobre o usuário e seu uso do site: Tarefas Concluídas, Precisão Média, Matérias matriculadas, Quantidade de acertos e Quantidade de acertos máximos. Cada uma das informações são auto explicativas.
<hr>
...
- Esta página exibe o acervo de livros disponíveis no site, cada um sepadado em um retângulo branco.
...
- A página começa com a primeira questão da tarefa. a IA descreve cada uma das opções de A a E, e o usuário pode selecionar a opção que ele julgar correta.
...
## Nossa Licença
Nosso projeto utuliza a licença do MIT.
